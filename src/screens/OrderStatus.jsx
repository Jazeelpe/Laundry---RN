    ...
    <View style={safeAreaStyle.mainContainer}>
      <View style={safeAreaStyle.container}>
        ...
        <View style={{ marginBottom: 25 }}>
          ...
          <TouchableOpacity onPress={datacreation}><Text>clickme</Text></TouchableOpacity>
        ...
        <View style={safeAreaStyle.progressContainer}>
          <Image style={{width:"100%",height:100}} source={require('../assets/images/status.png')} />
        </View>
        <View>
            <Text style={{ fontSize: 18, fontWeight: "500" }}>Delivered To</Text>
            <Text style={{ fontSize: 14, fontWeight: "400" }}>238 allahabad street,  sanitorium, chennai.</Text>
        </View>
      </View>
    </View>
  );
